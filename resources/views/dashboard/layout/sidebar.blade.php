      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/registerstaff">
                <i class="ni ni-planet text-orange"></i>
                <span class="nav-link-text">Add Staff</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/addstudents">
                <i class="ni ni-planet text-orange"></i>
            ...
            <li class="nav-item">
              <a class="nav-link" href="/studentranks">
                <i class="ni ni-planet text-orange"></i>
                <span class="nav-link-text">Student Ranks</span>
              </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/addclass">
                <i class="ni ni-planet text-orange"></i>
                <span class="nav-link-text">Customizations</span>
              </a>
            </li>
            <!-- <li class="nav-item">
